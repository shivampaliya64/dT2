...
import com.example.dt2.data.DataManager;
import com.example.dt2.database.DbExecutor;
import com.example.dt2.ui.DetailActivity;
import com.example.dt2.ui.SettingsActivity;
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        class MyViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
            ...
            public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
                contextMenu.add(0, R.id.ignore, getAdapterPosition(), "Add to ignore");
            }
        }
    }
